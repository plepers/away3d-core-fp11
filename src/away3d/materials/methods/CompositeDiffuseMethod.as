package away3d.materials.methods
{
	...
	public class CompositeDiffuseMethod extends BasicDiffuseMethod
	{
		...
		{
			var code : ShaderChunk = _baseDiffuseMethod.getFragmentCodePerLight(vo, lightIndex, lightDirReg, lightColReg, regCache);
		...
		{
			var code : ShaderChunk = _baseDiffuseMethod.getFragmentCodePerProbe(vo, lightIndex, cubeMapReg, weightRegister, regCache);
			_totalLightColorReg = _baseDiffuseMethod._totalLightColorReg;
			return code;
		}
